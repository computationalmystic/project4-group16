 ...
 */
define(['jquery','knockout', 'ojs/ojmodule-element-utils', 'ojs/ojknockouttemplateutils', 'ojs/ojrouter', 'ojs/ojresponsiveutils', 'ojs/ojresponsiveknockoututils', 'ojs/ojarraydataprovider',
  ...
  function($,ko, moduleUtils, KnockoutTemplateUtils, Router, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider, OffcanvasUtils) {
     function ControllerViewModel() {
         var self=this;
         this.topcommitsdata=ko.observableArray();
         this.pullRequestsdata=ko.observableArray();
         this.backlogdata=ko.observableArray();
         self.incidentsVisited=ko.observable(false);

var baseUrl1="http://augur.osshealth.io:5000/api/unstable/repo-groups";
var baseUrl2="http://augur.osshealth.io:5000/api/unstable/repos";
  ...
  this.repo=data;
      ...
      self.mdScreen = ResponsiveKnockoutUtils.createMediaQueryObservable(mdQuery);
       ...
       self.router.configure({
         ...
         'incidents': {label: 'Augur Data', isDefault: true},
      ...
      self.appName = ko.observable("AUGUR REPOSITORY METRICS");
